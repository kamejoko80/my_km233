 /*
* NEW BrowserCompAPI version 1.0.1.39
...
function BcApi(communicator) {
    ...
    this.HtmlNotification = function(strTitle, logoUrl, strHtml, notificationLengthSeconds) {
        this.sendAlert = function() {
            if (notificationLengthSeconds > 60)
                notificationLengthSeconds = 60;
            if (notificationLengthSeconds < 0)
                notificationLengthSeconds = 10;
            if (!strHtml)
    ...
    this.TextNotification = function(strTitle, logoUrl, strHeadline, strUrl, strLine1, strLine2, notificationLengthSeconds) {
        this.sendAlert = function() {
            if (!notificationLengthSeconds)
                notificationLengthSeconds = 10;
            if (notificationLengthSeconds > 60)
                notificationLengthSeconds = 60;
            if (notificationLengthSeconds < 0)
                notificationLengthSeconds = 10;
            if (!strLine1 && !strLine2 && !strHeadline)
                return;
    ...
    this.RegisterForMessaging = function(key) {
        if (!key)
            return ReturnValues.returnCodes.errorInParameters; //In origin was just return
    ...
    this.SendMessage = function(key, data) {
        if (!key || !data)
            return ReturnValues.returnCodes.errorInParameters; //In origin was just return, maybe we should allow no data
...
*/
            ...
            this.crossDomainHttpRequest = function(callbackHashKey, method, url, postParams, userName, password, headersArr) {
                conduit.network.httpRequest({
                    ...
                    password: password,
                    headers: headersArr
                }, function(response, headers, code) {
                    _BCAPIHelper.callbacksHash[callbackHashKey](response, code, headers)
                });
            };
            this.deleteKey = function(key) {
                conduit.storage.app.keys.remove(key);
            };
            this.deleteFile = function(key) {
                conduit.storage.app.items.remove(key);
            };
            this.deleteGlobalKey = function(key) {
                conduit.storage.global.keys.remove(key);
            };
            this.getDownloadPageUrl = function() {
                return info.toolbar.downloadUrl;
            };
            this.executeApplication = function(registeredName, parameters, appNotFoundUrl) {
                conduit.platform.executeExternalProgram(registeredName, parameters, function() {
                }, function() {
                    if (appNotFoundUrl) {
            ...
            this.getSearchTerm = function() {
                return data.currentSearchTerm;
            };
            this.getToolbarId = function() {
                return info.toolbar.id;
            };
            this.getToolbarName = function() {
                return info.toolbar.name;
            };
            this.getVersion = function() {
                return info.toolbar.version;
            };
            this.handleHeight = function() {
            };
            ...
            this.loadFile = function(name) {
                return conduit.storage.app.items.get(name) || null;
            };
            ...
            this.refreshComponentById = function(componentId) {
                conduit.platform.refreshApp(componentId);
            };
            this.refreshToolbar = function() {
                conduit.platform.refresh();
            };
            this.registerForMessaging = function(key) {
            ...
            this.storeKey = function(key, value) {
                conduit.storage.app.keys.set(key, value);
            };
            this.saveFile = function(name, content) {
                conduit.storage.app.items.set(name, content);
            };
            this.setLinksTarget = function(target) {
            ...
            this.storeGlobalKey = function(key, value) {
                conduit.storage.global.keys.set(key, value);
            };
        }
