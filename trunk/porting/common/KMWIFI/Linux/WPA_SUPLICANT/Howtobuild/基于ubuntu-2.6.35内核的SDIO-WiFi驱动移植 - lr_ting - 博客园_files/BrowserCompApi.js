/*
* NEW BrowserCompAPI version 1.0.2.18
...
if (window.conduitSmartBarIndicator || !isNotSmartbar() && (getContext(window.name) || /___requireStorage/.test(document.location.href) || myconduitAppData || typeof (abstractionlayer) !== "undefined")) {
...
createHiddenCommandDiv(functionName + ";" + uid + ";" + parentFrameId + ";" + encodeURIComponent(script) + ";" + uniqId + ";" + window.name + ";" + parentFrameId + "_" + uniqId);
};
...
"platform": { "isToolbarVisible": "", "getToolbarBornDate": "", "onChangeViewState": { "addListener": "eventHandler"}, "getToolbarVersion":"" ,"executeExternalProgram": "registeredName, parameters", "getAppsList": "", "getInfo": "", "isAppInstalled": "appId", "refresh": "forceRefresh", "refreshApp": "appId", "setSkin": "settings", "search": { "getTerm": "", "onExecuted": { "addListener": "eventHandler" }, "onTextChanged": { "addListener": "eventHandler"} }, "getScreenHeight": "", "getScreenWidth": "", "openApp": "guid" },
...
conduit.tabs.onRequest.addListener("callBackToAppThroughAppToTabCommunication_" + window.name,function(data){
...
conduit.tabs.executeScript(tabIdToInject || null, { code: "function EBCallBackMessageReceived(data) { conduitPage.sendRequest('callBackToAppThroughAppToTabCommunication_" + window.name + "', data); }" });
}
conduit.tabs.executeScript(tabIdToInject || null, { code: strScript, allFrames: allFrames });
}
...
this.executeScriptInFrame = function (frameId, script, callback){
var params = {parentFrameId: window.name, frameId: frameId, script: script};
var callbackFunction = createCBFunction(callback);
